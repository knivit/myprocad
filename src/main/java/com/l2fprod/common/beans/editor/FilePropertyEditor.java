...
public class FilePropertyEditor extends AbstractPropertyEditor {
    ...
    public FilePropertyEditor(boolean asTableEditor) {
        ...
        editorComponent.add("*", textfield = new JTextField());
        ...
        editorComponent.add(cancelButton = ComponentFactory.Helper.getFactory().createMiniButton());
        cancelButton.setText("X");
        cancelButton.addActionListener(e -> selectNull());
    ...
    protected void selectFile() {
        ...
        if (JFileChooser.APPROVE_OPTION == chooser.showOpenDialog(editorComponent)) {
            File oldFile = (File)getValue();
