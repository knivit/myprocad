...
public class OperatingSystem {
    private static final String EDITOR_SUB_FOLDER = ".tsoft";
    private static final String APPLICATION_SUB_FOLDER = "myprocad";
    ...
    public static boolean isMacOSXLeopardOrSuperior() {
        // Just need to test is OS version is different of 10.4 because My Pro CAD
    ...
    private synchronized static File getDefaultTemporaryFolder(boolean create) throws IOException {
        if (TEMPORARY_SUB_FOLDER != null) {
            ...
            if (!sessionTemporaryFolder.exists()) {
                // Retrieve existing folders working with same My Pro CAD version in temporary folder
