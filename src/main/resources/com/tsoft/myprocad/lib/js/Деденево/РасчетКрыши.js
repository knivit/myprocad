...
Console.print("*** Расчет крыши ***\n");

Console.print("                                  Q");
Console.print("                                  |    c");
Console.print("                     Q/(2*sin a)  V   /+\\--------> Q/(2*cos a)");
Console.print("                          /        /   |   \\");
Console.print("                      |/_       /      | Q/2  \\");
Console.print("                             /       g |         \\");
Console.print(" H=(Q*cos a)/(2*sin a)  b /+-----------+-----------+\\ d");
Console.print("    <------------      /   |                       |   \\");
Console.print("            P     k /      |                       |      \\");
Console.print("            |    /   \\     | (P+Q)/2               |    /     \\");
Console.print("            V /        \\   |                       |  /          \\");
...
Console.print("         |  /                                                    \\  |");
Console.print("       f +----------------------------------------------------------+");
Console.print("                               Рис. 2 Вид сверху\n");

Console.print("                                  |    c");
Console.print("                     Q/(2*sin a)  V   /+");
Console.print("                          /        /   |");
Console.print("                      |/_       /      |");
Console.print("                             /         |");
Console.print(" H=(Q*cos a)/(2*sin a)    /b +         |");
Console.print("    <------------      /     |         |");
Console.print("            P       /        |         |");
Console.print("            |    /           |(P+Q)/2  |");
Console.print("            V / + m          |         |");
...
Console.print("         | P/2          +               ");
Console.print("         V");
Console.print("           Рис. 3 Ребро вальмы\n");
...
Console.print("*** Конец расчета крыши ***");
