...
Стоимость_кладки_блоков$руб_за_м3 = 1300;
...
Стоимость_доставки_кирпича$руб_за_рейс = 8500 + 300*18; // перевозка длинномером плюс разрузка/довозка манипулятором по 300 руб за поддоно
Стоимость_кладки_кирпича$руб_за_м2 = 700;
...
Вес_мешка_цемента$кг = 40;
Стоимость_мешка_цемента$руб = 240;
...
$$6 = "\nСвязь кладок - металл. оцинкованная сетка 50х50 d=3 мм";
...
Ширина_сетки$м = 0.40;
Длина_карты_сетки$м = 2;
Цена_за_карту$руб = 117;
...
Итого_раствора$м3 = Количество_раствора_блоки$м3 + Количество_раствора_кирпичи$м3;
Итого_раствора$кг = Плотность_раствора_1Ц_2П$кг_на_м3 * Итого_раствора$м3;
Итого_цемента$кг = Итого_раствора$кг / 3;
Итого_мешков_цемента$шт = Итого_цемента$кг / Вес_мешка_цемента$кг;
...
output.print(
    ...
    "    ПРИМЕЧАНИЯ\n" +
    "********************\n" +
    "1. Темный кирпич - с полукруглым ребром\n" +
    "2. Уточнить, можно ли оплатить в четверг и забрать половину в пятницу, половину в субботу\n" +
    "3. Уточнить, может ли водитель получить кирпич по ксерокопии накладной\n" +
    "4. Взять паспорт + две расписки с водителя\n"
);
