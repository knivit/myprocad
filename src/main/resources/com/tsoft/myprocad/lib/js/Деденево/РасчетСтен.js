...
$$6 = "\nСвязь кладок - металл. оцинкованная сетка с ячейкой 50х50 рулон 0,50*48м d=1.6 мм";
Длина_рулона_сетки$м = 48;
Цена_за_рулон$руб = 1700;
...
Количество_рулонов_сетки$шт = (Периметр_кладки_сетки$м / Длина_рулона_сетки$м) * Количество_рядов_сетки$шт;
Стоимость_сетки$руб = Количество_рулонов_сетки$шт * Цена_за_рулон$руб;
...
Площадь_двери_блоков$м2 = 5 * 11 * 0.2 * 0.2;
Площадь_окна_блоков$м2 = 5 * 9 * 0.2 * 0.2;
Площадь_проемов_блоков$м2 = (9 * 11 + 4 * 11 + 6 * 11 + 4 * 11) * 0.2 * 0.2;
Площадь_кладки_блока$м2 = 3*(Длина_дома_блок$м * (14 + 14)*0.2) + 2*(Ширина_дома_блок$м * (14 + 14)*0.2) -
   Площадь_двери_блоков$м2 * 2 - Площадь_окна_блоков$м2 * (8 + 12) - Площадь_проемов_блоков$м2;
...
Купил_блоков$шт = 5 * 8 * 90 + 3 * 8 * 90 + 1 * 8 * 90;
...
Console.print("*** Конец расчета стен ***");
