...
var Стропило_xc = plan.addBeam(0, 0, 7200, 5300, Балки_перекрытия[2].getYStart(), 10200, 50, 200);
var Стропило_yc = plan.addBeam(5300, Балки_перекрытия[2].getYStart(), 10200, 10600, 0, 7200, 50, 200);
var Стропило_fv = plan.addBeam(0, 13500, 7200, 5300, Балки_перекрытия[10].getYStart(), 10200, 50, 200);
var Стропило_ve = plan.addBeam(5300, Балки_перекрытия[10].getYStart(), 10200, 13500, 10600, 7200, 50, 200);
...
var Стойка_fv1 = plan.addCrossBeam(Стропило_fv, Балки_перекрытия[11], 100, 100).setMaterial($$Брус100х100);
var Стойка_fv2 = plan.addCrossBeam(Стропило_fv, Балки_перекрытия[12], 100, 100).setMaterial($$Брус100х100);
//var Стойка_ve1 = plan.addCrossBeam(Стропило_ve, Балки_перекрытия[11], 100, 100).setMaterial($$Брус100х100);
//var Стойка_ve2 = plan.addCrossBeam(Стропило_ve, Балки_перекрытия[12], 100, 100).setMaterial($$Брус100х100);
